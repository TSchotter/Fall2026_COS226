...
class BinaryTree:
    ...
    def _copy_node(self, node):
        ...
        new_node.color = node.color  # Copy the color attribute
...
class TreeVisualizer:
    ...
    def draw_node(self, x, y, value, color="lightblue"):
        ...
        # Draw circle - use the provided color
        ...
        # Use white text for black nodes, black text for other colors
        text_color = "white" if color.upper() == "BLACK" else "black"
        self.turtle.pencolor(text_color)
        self.turtle.write(str(value), align="center", font=("Arial", 12, "bold"))
        self.turtle.pencolor("black")  # Reset to black for other drawing
    ...
    def draw_tree_recursive(self, node, x, y, level=0):
        ...
        # Draw current node with its color
        self.draw_node(x, y, node.data, node.color)
    ...
    def visualize(self):
        ...
        if tree.head is None:
            ...
            self.turtle.pendown()
            self.turtle.write("Empty Tree", align="center", font=("Arial", 16, "bold"))
            
            # Draw status bar
            self.draw_status_bar(800, 600)
            self.screen.update()
